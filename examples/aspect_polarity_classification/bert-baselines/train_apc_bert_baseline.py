...
from pyabsa.config import APCConfigManager
from pyabsa.dataset import ABSADatasetList
from pyabsa.models import BERTBaselineAPCModelList
...
sent_classifier = train_apc(config=apc_config_english,  # set config=None will use the apc_config as well
